...
public class Check_Result_Camb {
	...
	//Click to Find Location
		public static void Find_Venu_Process(ChromeDriver driver) {
			...
			Find_Your_Location.Venue_Search_Object(driver).sendKeys("Camberwell");
			Find_Your_Location.Venue_Search_Object(driver).sendKeys(Keys.ENTER);
		}
